 ...
 <v-row class="mt-n6">
    ...
    > 
      ...
      >
        ...
        <v-avatar size="40">
          <v-img src="https://i.pinimg.com/originals/df/4e/fe/df4efe807b8f3040091fc9e37f149210.jpg"></v-img>
        </v-avatar>
      
        </v-list-item-avatar>
</v-badge>
        <v-list-item-content>
          <v-list-item-title >Stigma</v-list-item-title>
    ...
    > 
      ...
      >
        ...
        <v-avatar size="40">
          <v-img src="https://m.media-amazon.com/images/I/51W8-fR7E-L.jpg"></v-img>
        </v-avatar>
      
        </v-list-item-avatar>
</v-badge>
        <v-list-item-content>
          <v-list-item-title >Shadowy</v-list-item-title>
    ...
    > 
      ...
      >
        ...
        <v-avatar size="40">
          <v-img src="https://avatars.githubusercontent.com/u/38929104?v=4"></v-img>
        </v-avatar>
      
        </v-list-item-avatar>
</v-badge>
        <v-list-item-content>
          <v-list-item-title >Apprendiz</v-list-item-title>
    ...
    > 
      ...
      >
        ...
        <v-avatar size="40">
          <v-img src="https://smoll-ice.com/site/wp-content/uploads/menuD3D.jpg"></v-img>
        </v-avatar>
      
        </v-list-item-avatar>
</v-badge>
        <v-list-item-content>
          <v-list-item-title >Smoll_Ice</v-list-item-title>
